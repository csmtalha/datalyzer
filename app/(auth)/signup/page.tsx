...
import { BarChart2, Loader2, Mail, User } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-[#080e1a] flex items-center justify-center px-4">
        ...
        <div className="relative w-full max-w-md text-center space-y-4">
          ...
          <Link href="/login" className="inline-block text-cyan-400 hover:text-cyan-300 text-sm font-medium mt-4">
            Back to login
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#080e1a] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-slate-400 mt-2">Start analyzing data in seconds</p>
        </div>
